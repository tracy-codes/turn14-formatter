...
For speed's sake I did not include a download function to automatically download the product data loadsheet. You may can run the following: ```python python download.py```to download the loadsheet without needing to go to turn14.com.  
